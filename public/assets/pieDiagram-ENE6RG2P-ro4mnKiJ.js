import{m as e}from"./src-DVPOk4iJ.js";import{H as t,K as n,U as r,a as i,c as a,f as o,v as s,w as c,x as l,y as u}from"./chunk-WYO6CB5R-DCA0xw92.js";import{n as d}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{t as f}from"./ordinal-hYBb2elL.js";import{n as p}from"./path-BWPyau1x.js";import{m}from"./dist-Ak9I-6fh.js";import{t as h}from"./arc-_-hoRWg_.js";import{t as g}from"./array-BifhSqXX.js";import{i as _,p as v}from"./chunk-ICXQ74PX-De6Ez4BY.js";import{f as y}from"./index-DOlZZl1a.js";import{n as b}from"./mermaid-parser.core-DfPW1ibx.js";import{t as x}from"./chunk-JWPE2WC7-DVXcaiue.js";function S(e,t){return t<e?-1:t>e?1:t>=e?0:NaN}function C(e){return e}function w(){var e=C,t=S,n=null,r=p(0),i=p(m),a=p(0);function o(o){var s,c=(o=g(o)).length,l,u,d=0,f=Array(c),p=Array(c),h=+r.apply(this,arguments),_=Math.min(m,Math.max(-m,i.apply(this,arguments)-h)),v,y=Math.min(Math.abs(_)/c,a.apply(this,arguments)),b=y*(_<0?-1:1),x;for(s=0;s<c;++s)(x=p[f[s]=s]=+e(o[s],s,o))>0&&(d+=x);for(t==null?n!=null&&f.sort(function(e,t){return n(o[e],o[t])}):f.sort(function(e,n){return t(p[e],p[n])}),s=0,u=d?(_-c*b)/d:0;s<c;++s,h=v)l=f[s],x=p[l],v=h+(x>0?x*u:0)+b,p[l]={data:o[l],index:s,value:x,startAngle:h,endAngle:v,padAngle:y};return p}return o.value=function(t){return arguments.length?(e=typeof t==`function`?t:p(+t),o):e},o.sortValues=function(e){return arguments.length?(t=e,n=null,o):t},o.sort=function(e){return arguments.length?(n=e,t=null,o):n},o.startAngle=function(e){return arguments.length?(r=typeof e==`function`?e:p(+e),o):r},o.endAngle=function(e){return arguments.length?(i=typeof e==`function`?e:p(+e),o):i},o.padAngle=function(e){return arguments.length?(a=typeof e==`function`?e:p(+e),o):a},o}var T=o.pie,E={sections:new Map,showData:!1,config:T},D=E.sections,O=E.showData,k=structuredClone(T),A={getConfig:d(()=>structuredClone(k),`getConfig`),clear:d(()=>{D=new Map,O=E.showData,i()},`clear`),setDiagramTitle:n,getDiagramTitle:c,setAccTitle:r,getAccTitle:u,setAccDescription:t,getAccDescription:s,addSection:d(({label:t,value:n})=>{if(n<0)throw Error(`"${t}" has invalid value: ${n}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);D.has(t)||(D.set(t,n),e.debug(`added new section: ${t}, with value: ${n}`))},`addSection`),getSections:d(()=>D,`getSections`),setShowData:d(e=>{O=e},`setShowData`),getShowData:d(()=>O,`getShowData`)},j=d((e,t)=>{x(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),M={parse:d(async t=>{let n=await b(`pie`,t);e.debug(n),j(n,A)},`parse`)},N=d(e=>`
  .pieCircle{
